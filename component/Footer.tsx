...
const Footer: React.FC = () => (
  <footer className="relative text-white py-5 px-3 mt-20 text-center bg-gradient-to-b from-[var(--brand)] to-[var(--brand-dark)] dark:from-gray-950 dark:to-gray-900 shadow-2xl overflow-hidden">
    {/* subtle polygon texture */}
    <div className="absolute inset-0 pointer-events-none z-0">
      <svg width="100%" height="100%" viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        <polygon points="0,120 1440,0 1440,120" fill="#FBF7EE" opacity="0.10" />
        <polygon points="0,120 0,60 1440,0 1440,120" fill="#E9B44C" opacity="0.10" />
      </svg>
    </div>
    ...
    <div className="relative z-10 mt-3 text-sm text-[var(--brand-light)] font-mono drop-shadow">
